...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lbl_change_method = QtGui.QLabel(self.tab_desktop_environment)
        self.lbl_change_method.setObjectName(_fromUtf8("lbl_change_method"))
        self.horizontalLayout_8.addWidget(self.lbl_change_method)
        spacerItem11 = QtGui.QSpacerItem(28, 20, QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Minimum)
        self.horizontalLayout_8.addItem(spacerItem11)
        self.cb_change_method = QtGui.QComboBox(self.tab_desktop_environment)
        self.cb_change_method.setObjectName(_fromUtf8("cb_change_method"))
        ...
        self.tabWidget.addTab(self.tab_desktop_environment, _fromUtf8(""))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_change_method.setText(_translate("MainWindow", "Wallpaper change method", None))
        self.cb_change_method.setItemText(0, _translate("MainWindow", "Unity", None))
